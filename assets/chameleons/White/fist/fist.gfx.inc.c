...
Gfx White_fist_Gfx[] = {
    ...
    gsSPVertex(&White_fist_Vtx[0], 4, 0),
    ...
    gsSPVertex(&White_fist_Vtx[4], 4, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsSP1Triangle(3, 2, 1, 0),
    gsDPPipeSync(),
    ...
    gsSPVertex(&White_fist_Vtx[8], 4, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsSP1Triangle(3, 2, 1, 0),
    gsDPPipeSync(),
    ...
    gsSPVertex(&White_fist_Vtx[12], 6, 0),
    ...
    gsSPVertex(&White_fist_Vtx[18], 9, 0),
    ...
    gsSPVertex(&White_fist_Vtx[27], 14, 0),
