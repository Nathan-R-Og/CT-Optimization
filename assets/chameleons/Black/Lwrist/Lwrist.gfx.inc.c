...
Gfx Black_Lwrist_Gfx[] = {
    ...
    gsSPVertex(&Black_Lwrist_Vtx[0], 8, 0),
    ...
    gsDPLoadTLUT_pal16(0, Black_wrist_ci4_PAL),
    gsDPLoadTextureTile_4b(Black_wrist_ci4_PNG, G_IM_FMT_CI, 32, 0, 0, 0, 31, 31, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetCombineMode(G_CC_MODULATEIA, G_CC_MODULATEIA),

    gsSPVertex(&Black_Lwrist_Vtx[8], 6, 0),
    ...
    gsSPVertex(&Black_Lwrist_Vtx[14], 15, 0),
