...
Gfx Battle_Chameleons_Fred_fist_Gfx[] = {
    ...
    gsSPVertex(&Battle_Chameleons_Fred_fist_Vtx[0], 4, 0),
    ...
    gsSPVertex(&Battle_Chameleons_Fred_fist_Vtx[4], 4, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsSP1Triangle(3, 2, 1, 0),
    gsDPPipeSync(),
    ...
    gsSPVertex(&Battle_Chameleons_Fred_fist_Vtx[8], 4, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsSP1Triangle(3, 2, 1, 0),
    gsDPPipeSync(),
    ...
    gsSPVertex(&Battle_Chameleons_Fred_fist_Vtx[12], 4, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsSP1Triangle(3, 2, 1, 0),
    gsDPPipeSync(),
    ...
    gsSPVertex(&Battle_Chameleons_Fred_fist_Vtx[16], 4, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsSP1Triangle(3, 2, 1, 0),
    gsDPPipeSync(),
    ...
    gsSPVertex(&Battle_Chameleons_Fred_fist_Vtx[20], 7, 0),
