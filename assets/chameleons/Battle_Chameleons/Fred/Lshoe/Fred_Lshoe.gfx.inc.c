...
Gfx Battle_Chameleons_Fred_Lshoe_Gfx[] = {
    ...
    gsDPLoadTLUT_pal256(Battle_Chameleons_Fred_shoe_ci8_PAL),
    gsDPLoadTextureTile(Battle_Chameleons_Fred_shoe_ci8_PNG, G_IM_FMT_CI, G_IM_SIZ_8b, 64, 0, 0, 0, 63, 31, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, 6, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetCombineMode(G_CC_MODULATEIA, G_CC_MODULATEIA),

    gsSPVertex(&Battle_Chameleons_Fred_Lshoe_Vtx[0], 5, 0),
