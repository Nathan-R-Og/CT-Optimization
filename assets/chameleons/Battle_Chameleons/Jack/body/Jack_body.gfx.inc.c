...
Gfx Battle_Chameleons_Jack_body_Gfx[] = {
    ...
    gsDPLoadTLUT_pal16(0, Battle_Chameleons_Jack_backpackStrap_ci4_PAL),
    gsDPLoadTextureTile_4b(Battle_Chameleons_Jack_backpackStrap_ci4_PNG, G_IM_FMT_CI, 32, 0, 0, 0, 31, 63, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, 5, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetCombineMode(G_CC_MODULATEIA, G_CC_MODULATEIA),

    gsSPVertex(&Battle_Chameleons_Jack_body_Vtx[0], 11, 0),
    ...
    gsDPSetPrimColor(0, 0, 0x19, 0xAD, 0x74, 0xFF),

    gsSPVertex(&Battle_Chameleons_Jack_body_Vtx[11], 5, 0),
    ...
    gsDPLoadTLUT_pal16(0, Battle_Chameleons_Jack_number_ci4_PAL),
    gsDPLoadTextureTile_4b(Battle_Chameleons_Jack_number_ci4_PNG, G_IM_FMT_CI, 32, 0, 0, 0, 31, 31, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetCombineMode(G_CC_MODULATEIA, G_CC_MODULATEIA),

    gsSPVertex(&Battle_Chameleons_Jack_body_Vtx[16], 4, 0),
