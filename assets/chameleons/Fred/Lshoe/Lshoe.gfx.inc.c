...
Gfx Fred_Lshoe_Gfx[] = {
    ...
    gsDPLoadTLUT_pal16(0, Fred_shoe_ci4_PAL),
    gsDPLoadTextureTile_4b(Fred_shoe_ci4_PNG, G_IM_FMT_CI, 64, 0, 0, 0, 63, 31, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, 6, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetCombineMode(G_CC_MODULATEIA, G_CC_MODULATEIA),

    gsSPVertex(&Fred_Lshoe_Vtx[0], 16, 0),
    ...
    gsSPVertex(&Fred_Lshoe_Vtx[16], 6, 10),
    ...
    gsSPVertex(&Fred_Lshoe_Vtx[22], 13, 0),
    ...
    gsSPVertex(&Fred_Lshoe_Vtx[35], 9, 7),
