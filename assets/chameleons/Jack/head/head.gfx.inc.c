...
Gfx Jack_head_Gfx[] = {
    ...
    gsDPLoadTLUT_pal256(Jack_eyeL_ci8_PAL),
    gsDPLoadTextureTile(Jack_eyeL_ci8_PNG, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 0, 0, 0, 31, 31, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetCombineMode(G_CC_MODULATEIA, G_CC_MODULATEIA),

    gsSPVertex(&Jack_head_Vtx[0], 4, 0),
    gsSP1Triangle(0, 2, 3, 0),
    gsSP1Triangle(3, 2, 1, 0),
    gsDPPipeSync(),

    gsDPLoadTLUT_pal256(Jack_eyeR_ci8_PAL),
    gsDPLoadTextureTile(Jack_eyeR_ci8_PNG, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 0, 0, 0, 31, 31, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetCombineMode(G_CC_MODULATEIA, G_CC_MODULATEIA),

    gsSPVertex(&Jack_head_Vtx[4], 4, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsSP1Triangle(3, 2, 1, 0),
    gsDPPipeSync(),

    gsDPLoadTLUT_pal16(0, Jack_cheek_ci4_PAL),
    gsDPLoadTextureTile_4b(Jack_cheek_ci4_PNG, G_IM_FMT_CI, 32, 0, 0, 0, 31, 31, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetCombineMode(G_CC_MODULATEIA, G_CC_MODULATEIA),

    gsSPVertex(&Jack_head_Vtx[8], 16, 0),
    ...
    gsSPVertex(&Jack_head_Vtx[24], 12, 4),
    ...
    gsSPVertex(&Jack_head_Vtx[36], 8, 0),
    ...
    gsSPVertex(&Jack_head_Vtx[44], 11, 5),
    ...
    gsSPVertex(&Jack_head_Vtx[55], 15, 0),
    ...
    gsSPVertex(&Jack_head_Vtx[70], 5, 11),
