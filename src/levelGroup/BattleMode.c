...
extern CollisionData BattleMode_unkCol1_ColH;
extern Gfx BattleMode_model2_Gfx[];
extern CollisionData BattleMode_unkCol2_ColH;
extern Gfx BattleMode_model3_Gfx[];
extern CollisionData BattleMode_unkCol3_ColH;
extern Gfx BattleMode_model4_Gfx[];
extern CollisionData BattleMode_unkCol4_ColH;
extern Gfx BattleMode_model5_Gfx[];
extern CollisionData BattleMode_unkCol5_ColH;
extern Gfx BattleMode_model6_Gfx[];
extern CollisionData BattleMode_unkCol6_ColH;
extern Gfx BattleMode_model7_Gfx[];
extern CollisionData BattleMode_unkCol7_ColH;
extern Gfx BattleMode_model8_Gfx[];
extern CollisionData BattleMode_unkCol8_ColH;
extern Gfx BattleMode_model9_Gfx[];
extern CollisionData BattleMode_unkCol9_ColH;
extern Gfx BattleMode_model10_Gfx[];
extern CollisionData BattleMode_unkCol10_ColH;
extern Gfx BattleMode_model11_Gfx[];
extern CollisionData BattleMode_unkCol11_ColH;
extern Gfx BattleMode_model12_Gfx[];
extern CollisionData BattleMode_unkCol12_ColH;
extern Gfx BattleMode_model13_Gfx[];
extern CollisionData BattleMode_unkCol13_ColH;
extern Gfx BattleMode_model14_Gfx[];
extern CollisionData BattleMode_unkCol14_ColH;
extern Gfx BattleMode_model15_Gfx[];
extern CollisionData BattleMode_unkCol15_ColH;
extern Gfx BattleMode_model16_Gfx[];
extern CollisionData BattleMode_unkCol16_ColH;
extern Gfx BattleMode_model17_Gfx[];
extern CollisionData BattleMode_unkCol17_ColH;
extern Gfx BattleMode_model18_Gfx[];
extern CollisionData BattleMode_unkCol18_ColH;
extern Gfx BattleMode_model19_Gfx[];
extern CollisionData BattleMode_unkCol19_ColH;
extern Gfx BattleMode_model20_Gfx[];
extern CollisionData BattleMode_unkCol20_ColH;
extern Gfx BattleMode_model21_Gfx[];
extern CollisionData BattleMode_unkCol21_ColH;
extern Gfx BattleMode_model22_Gfx[];
extern CollisionData BattleMode_unkCol22_ColH;
extern Gfx BattleMode_model23_Gfx[];
extern CollisionData BattleMode_unkCol23_ColH;
extern Gfx BattleMode_model24_Gfx[];
extern CollisionData BattleMode_unkCol24_ColH;
extern Gfx BattleMode_model25_Gfx[];
extern CollisionData BattleMode_unkCol25_ColH;
extern Gfx BattleMode_model26_Gfx[];
extern CollisionData BattleMode_unkCol26_ColH;
extern Gfx BattleMode_model27_Gfx[];
extern CollisionData BattleMode_unkCol27_ColH;
extern Gfx BattleMode_model28_Gfx[];
extern CollisionData BattleMode_unkCol28_ColH;
extern Gfx BattleMode_model29_Gfx[];
extern CollisionData BattleMode_unkCol29_ColH;
extern Gfx BattleMode_model30_Gfx[];
extern CollisionData BattleMode_unkCol30_ColH;
...
#include "assets/levelGroup/BattleMode/model1/model1.vtx.inc.c"

#include "assets/levelGroup/BattleMode/model1/model1.gfx.inc.c"

#include "assets/levelGroup/BattleMode/model2/model2.vtx.inc.c"
unsigned char BattleMode_ice_ci4_PNG[] = {
#include "build/assets/levelGroup/BattleMode/img/ice.ci4.png.inc.c"
};
unsigned char BattleMode_ice_ci4_PAL[] = {
#include "build/assets/levelGroup/BattleMode/img/ice.ci4.pal.inc.c"
};

#include "assets/levelGroup/BattleMode/model2/model2.gfx.inc.c"

#include "assets/levelGroup/BattleMode/model3/model3.vtx.inc.c"

#include "assets/levelGroup/BattleMode/model3/model3.gfx.inc.c"

#include "assets/levelGroup/BattleMode/model4/model4.vtx.inc.c"
unsigned char BattleMode_rocks_ci4_PNG[] = {
#include "build/assets/levelGroup/BattleMode/img/rocks.ci4.png.inc.c"
};
unsigned char BattleMode_rocks_ci4_PAL[] = {
#include "build/assets/levelGroup/BattleMode/img/rocks.ci4.pal.inc.c"
};

#include "assets/levelGroup/BattleMode/model4/model4.gfx.inc.c"

#include "assets/levelGroup/BattleMode/model5/model5.vtx.inc.c"

#include "assets/levelGroup/BattleMode/model5/model5.gfx.inc.c"

#include "assets/levelGroup/BattleMode/model6/model6.vtx.inc.c"

#include "assets/levelGroup/BattleMode/model6/model6.gfx.inc.c"

#include "assets/levelGroup/BattleMode/model7/model7.vtx.inc.c"

#include "assets/levelGroup/BattleMode/model7/model7.gfx.inc.c"

#include "assets/levelGroup/BattleMode/model8/model8.vtx.inc.c"

#include "assets/levelGroup/BattleMode/model8/model8.gfx.inc.c"

#include "assets/levelGroup/BattleMode/model9/model9.vtx.inc.c"

#include "assets/levelGroup/BattleMode/model9/model9.gfx.inc.c"

#include "assets/levelGroup/BattleMode/model10/model10.vtx.inc.c"

#include "assets/levelGroup/BattleMode/model10/model10.gfx.inc.c"

#include "assets/levelGroup/BattleMode/model11/model11.vtx.inc.c"
unsigned char BattleMode_ice2_ci4_PNG[] = {
#include "build/assets/levelGroup/BattleMode/img/ice2.ci4.png.inc.c"
};
unsigned char BattleMode_ice2_ci4_PAL[] = {
#include "build/assets/levelGroup/BattleMode/img/ice2.ci4.pal.inc.c"
};

#include "assets/levelGroup/BattleMode/model11/model11.gfx.inc.c"

#include "assets/levelGroup/BattleMode/model12/model12.vtx.inc.c"

#include "assets/levelGroup/BattleMode/model12/model12.gfx.inc.c"

#include "assets/levelGroup/BattleMode/model13/model13.vtx.inc.c"

#include "assets/levelGroup/BattleMode/model13/model13.gfx.inc.c"

#include "assets/levelGroup/BattleMode/model14/model14.vtx.inc.c"
unsigned char BattleMode_ice2_rgba16_PNG[] = {
#include "build/assets/levelGroup/BattleMode/img/ice2.rgba16.png.inc.c"
};

#include "assets/levelGroup/BattleMode/model14/model14.gfx.inc.c"

#include "assets/levelGroup/BattleMode/model15/model15.vtx.inc.c"

#include "assets/levelGroup/BattleMode/model15/model15.gfx.inc.c"

#include "assets/levelGroup/BattleMode/model16/model16.vtx.inc.c"

#include "assets/levelGroup/BattleMode/model16/model16.gfx.inc.c"

#include "assets/levelGroup/BattleMode/model17/model17.vtx.inc.c"

#include "assets/levelGroup/BattleMode/model17/model17.gfx.inc.c"

#include "assets/levelGroup/BattleMode/model18/model18.vtx.inc.c"

#include "assets/levelGroup/BattleMode/model18/model18.gfx.inc.c"

#include "assets/levelGroup/BattleMode/model19/model19.vtx.inc.c"

#include "assets/levelGroup/BattleMode/model19/model19.gfx.inc.c"

#include "assets/levelGroup/BattleMode/model20/model20.vtx.inc.c"

#include "assets/levelGroup/BattleMode/model20/model20.gfx.inc.c"

#include "assets/levelGroup/BattleMode/model21/model21.vtx.inc.c"

#include "assets/levelGroup/BattleMode/model21/model21.gfx.inc.c"

#include "assets/levelGroup/BattleMode/model22/model22.vtx.inc.c"

#include "assets/levelGroup/BattleMode/model22/model22.gfx.inc.c"

#include "assets/levelGroup/BattleMode/model23/model23.vtx.inc.c"

#include "assets/levelGroup/BattleMode/model23/model23.gfx.inc.c"

#include "assets/levelGroup/BattleMode/model24/model24.vtx.inc.c"

#include "assets/levelGroup/BattleMode/model24/model24.gfx.inc.c"

#include "assets/levelGroup/BattleMode/model25/model25.vtx.inc.c"

#include "assets/levelGroup/BattleMode/model25/model25.gfx.inc.c"

#include "assets/levelGroup/BattleMode/model26/model26.vtx.inc.c"

#include "assets/levelGroup/BattleMode/model26/model26.gfx.inc.c"

#include "assets/levelGroup/BattleMode/model27/model27.vtx.inc.c"

#include "assets/levelGroup/BattleMode/model27/model27.gfx.inc.c"

#include "assets/levelGroup/BattleMode/model28/model28.vtx.inc.c"

#include "assets/levelGroup/BattleMode/model28/model28.gfx.inc.c"

#include "assets/levelGroup/BattleMode/model29/model29.vtx.inc.c"

#include "assets/levelGroup/BattleMode/model29/model29.gfx.inc.c"

#include "assets/levelGroup/BattleMode/model30/model30.vtx.inc.c"
...
#include "assets/levelGroup/BattleMode/a_model1/a_model1.vtx.inc.c"
unsigned char BattleMode_popcorn_ci8_PNG[] = {
#include "build/assets/levelGroup/BattleMode/img/popcorn.ci8.png.inc.c"
};
unsigned char BattleMode_popcorn_ci8_PAL[] = {
#include "build/assets/levelGroup/BattleMode/img/popcorn.ci8.pal.inc.c"
};
unsigned char BattleMode_bucket_rgba16_PNG[] = {
#include "build/assets/levelGroup/BattleMode/img/bucket.rgba16.png.inc.c"
};

#include "assets/levelGroup/BattleMode/a_model1/a_model1.gfx.inc.c"

#include "assets/levelGroup/BattleMode/anim/unk1Header.animH.inc.c"

#include "assets/levelGroup/BattleMode/anim/unk1.animArr.inc.c"

#include "assets/levelGroup/BattleMode/anim/unk1Pointers.animP.inc.c"
